        ...
        <div className="grid gap-14 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <p className="mt-5 text-muted-foreground">
              Founded by ex-Goldman traders and crypto-native quants, Gold Empire Investment marries
              old-world commodity discipline with the velocity of digital assets. We trade so you
              don't have to.
            </p>
              ...
              {[
                {
                  icon: ShieldCheck,
                  t: "Custodied & insured",
                  d: "Funds held with regulated tier-1 custodians.",
                },
                {
                  icon: Award,
                  t: "Audited monthly",
                  d: "Independent third-party audits, every 30 days.",
                },
                {
                  icon: Globe2,
                  t: "Global reach",
                  d: "Investors from 194 countries, 24/7 support desks.",
                },
              ].map((f) => (
